...
const DeviceWrapperAnimation = (isAnimation: boolean) => {
  return isAnimation
    ? {
        animate: {
          y: [-5, 5, -5],
...
function DeviceUI({ cover, deviceType, isAnimation }: PropsUI) {
  return (
    <div className='device'>
      <motion.div
        className='device__light'
      ...
      {deviceType === 'tablet' && (
        <motion.div
          ...
          {...DeviceWrapperAnimation(isAnimation)}
        >
